...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Write a detailed, well-structured article about "${input}".
The article should be ${selectedLength.text}.
Include:
- Introduction
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                Enter a title and click "Generate Article" to create your
                content
              </p>
            </div>
          </div>
