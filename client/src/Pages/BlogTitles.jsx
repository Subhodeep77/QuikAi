...
Generate EXACTLY 5 high-quality blog titles for the keyword "${input}" in the "${selectedCategory}" category.
...
Example format:
1. First full blog title here
2. Second full blog title here
3. Third full blog title here
4. Fourth full blog title here
5. Fifth full blog title here`;
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <input
          ...
          placeholder="Enter a keyword for your blog title"
          required
        />
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>
                Enter a keyword and click "Generate Title" to create your blog
                titles
              </p>
            </div>
          </div>
