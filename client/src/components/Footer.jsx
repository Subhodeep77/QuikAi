    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Exprience the future of content creation with Quick.ai. <br /> Our AI-powered platform helps you create high-quality content effortlessly, so you can focus on what matters most - growing your audience and achieving your goals.
            </p>
        </div>
